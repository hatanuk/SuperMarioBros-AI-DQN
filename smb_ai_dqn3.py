...
class Logger:
    ...
    def log_dqn_episode(self, episode_rewards, episode_steps, episode_num):
...
def run_dqn_agent(config, data_queue, dqn_model):
    ...
    if dqn_model:
        ...
        mario_DQN.model.learn(total_timesteps=int(1e6), callback=callback, log_interval=1000000)
